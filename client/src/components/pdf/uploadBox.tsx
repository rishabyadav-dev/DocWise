        ...
        >
          {!pdf && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              {...getRootProps({})}
              className={`flex flex-col items-center p-10 rounded-2xl bg-gray-100 hover:bg-gray-200 hover:border-1 border-gray-500 border-dashed shadow-2xl duration-500 text-gray-800 min-h-70 outline-none transition-colors cursor-pointer 
              ${dropzoneBorderColor} ${
                isDragActive
          ...
          {pdf && (
            <motion.div
              ...
              key={pdf.name}
              className="border border-gray-200 rounded-2xl p-1 flex h-fit justify-center lg:max-w-full max-w-[85px] flex-col items-center text-center bg-gray-50/50"
            >
          ...
          {pdf && (
            <motion.div className="flex justify-center items-center mt-2">
              <Button
                key={"sendbutton"}
                className={`hover:bg-black/80 font-sans font-bold bg-black duration-500 w-14 lg:w-full lg:h-12 h-12 rounded-2xl cursor-pointer`}
