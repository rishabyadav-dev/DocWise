...
export default function SignInPage() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-black to-gray-900 dark:from-black dark:to-gray-950 p-4">
      <div className="w-full max-w-md space-y-8 bg-gray-900 dark:bg-black p-8 rounded-xl shadow-lg dark:shadow-black/50">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-white">
            Welcome back to Docwise
          </h1>
        ...
        <div className="space-y-4">
          <Button
            ...
            variant="outline"
            className="w-full cursor-pointer border-gray-600 text-gray-200"
          >
            {googleloader ? (
              <Loader size={20} />
            ) : (
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="h-11 bg-gray-800 text-gray-200 border-gray-700"
              />
            </div>
            ...
            <Button
              ...
              className="w-full h-11 bg-gray-700 hover:bg-gray-600 text-white"
              disabled={loader}
            >
              {loader ? <Loader size={20} /> : "Sign in"}
            </Button>
          </div>
        </div>
